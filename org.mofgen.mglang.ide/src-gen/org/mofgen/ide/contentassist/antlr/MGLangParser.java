...
public class MGLangParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MGLangGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getParameterRefOrMethodCallAccess().getAlternatives(), "rule__ParameterRefOrMethodCall__Alternatives");
			...
			builder.put(grammarAccess.getNodeOrParameterOrCollectionAccess().getAlternatives(), "rule__NodeOrParameterOrCollection__Alternatives");
			...
			builder.put(grammarAccess.getSingleLineIfAccess().getGroup(), "rule__SingleLineIf__Group__0");
			builder.put(grammarAccess.getGenCommandBlockAccess().getGroup(), "rule__GenCommandBlock__Group__0");
			builder.put(grammarAccess.getBlockIfAccess().getGroup(), "rule__BlockIf__Group__0");
			builder.put(grammarAccess.getBlockIfAccess().getGroup_2(), "rule__BlockIf__Group_2__0");
			builder.put(grammarAccess.getBlockIfAccess().getGroup_2_0(), "rule__BlockIf__Group_2_0__0");
			builder.put(grammarAccess.getBlockIfAccess().getGroup_2_1(), "rule__BlockIf__Group_2_1__0");
			builder.put(grammarAccess.getIfHeadAndBodyAccess().getGroup(), "rule__IfHeadAndBody__Group__0");
			...
			builder.put(grammarAccess.getForEachHeadAccess().getRefAssignment_2(), "rule__ForEachHead__RefAssignment_2");
			builder.put(grammarAccess.getForEachHeadAccess().getIteratorVarAssignment_4(), "rule__ForEachHead__IteratorVarAssignment_4");
			builder.put(grammarAccess.getSingleLineIfAccess().getConditionAssignment_2(), "rule__SingleLineIf__ConditionAssignment_2");
			builder.put(grammarAccess.getSingleLineIfAccess().getCommandAssignment_4(), "rule__SingleLineIf__CommandAssignment_4");
			builder.put(grammarAccess.getGenCommandBlockAccess().getCommandsAssignment_1(), "rule__GenCommandBlock__CommandsAssignment_1");
			builder.put(grammarAccess.getBlockIfAccess().getIfAssignment_1(), "rule__BlockIf__IfAssignment_1");
			builder.put(grammarAccess.getBlockIfAccess().getElseifsAssignment_2_0_2(), "rule__BlockIf__ElseifsAssignment_2_0_2");
			builder.put(grammarAccess.getBlockIfAccess().getElseAssignment_2_1_1(), "rule__BlockIf__ElseAssignment_2_1_1");
			builder.put(grammarAccess.getIfHeadAndBodyAccess().getHeadAssignment_1(), "rule__IfHeadAndBody__HeadAssignment_1");
			builder.put(grammarAccess.getIfHeadAndBodyAccess().getBodyAssignment_4(), "rule__IfHeadAndBody__BodyAssignment_4");
			builder.put(grammarAccess.getIfHeadAccess().getConditionAssignment(), "rule__IfHead__ConditionAssignment");
			builder.put(grammarAccess.getIfBodyAccess().getCommandsAssignment(), "rule__IfBody__CommandsAssignment");
			...
			builder.put(grammarAccess.getCaseAccess().getValAssignment_1(), "rule__Case__ValAssignment_1");
			builder.put(grammarAccess.getCaseAccess().getBodyAssignment_3(), "rule__Case__BodyAssignment_3");
