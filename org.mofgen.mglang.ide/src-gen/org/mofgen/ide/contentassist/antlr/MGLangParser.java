...
public class MGLangParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MGLangGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getElseIfOrElseAccess().getAlternatives(), "rule__ElseIfOrElse__Alternatives");
			...
			builder.put(grammarAccess.getIfStatementAccess().getGroup_8(), "rule__IfStatement__Group_8__0");
			builder.put(grammarAccess.getElseIfOrElseAccess().getGroup_0(), "rule__ElseIfOrElse__Group_0__0");
			builder.put(grammarAccess.getElseIfOrElseAccess().getGroup_0_7(), "rule__ElseIfOrElse__Group_0_7__0");
			...
			builder.put(grammarAccess.getIfStatementAccess().getCondAssignment_3(), "rule__IfStatement__CondAssignment_3");
			builder.put(grammarAccess.getIfStatementAccess().getThenAssignment_6(), "rule__IfStatement__ThenAssignment_6");
			builder.put(grammarAccess.getIfStatementAccess().getElseIfAssignment_8_1(), "rule__IfStatement__ElseIfAssignment_8_1");
			builder.put(grammarAccess.getElseIfOrElseAccess().getCondAssignment_0_2(), "rule__ElseIfOrElse__CondAssignment_0_2");
			builder.put(grammarAccess.getElseIfOrElseAccess().getThenAssignment_0_5(), "rule__ElseIfOrElse__ThenAssignment_0_5");
			builder.put(grammarAccess.getElseIfOrElseAccess().getElseIfAssignment_0_7_1(), "rule__ElseIfOrElse__ElseIfAssignment_0_7_1");
			builder.put(grammarAccess.getElseStatementAccess().getElseAssignment_2(), "rule__ElseStatement__ElseAssignment_2");
			...
			builder.put(grammarAccess.getCaseBodyAccess().getExpressionsAssignment_1(), "rule__CaseBody__ExpressionsAssignment_1");
