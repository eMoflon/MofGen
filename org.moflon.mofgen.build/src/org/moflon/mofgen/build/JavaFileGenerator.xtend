...
class JavaFileGenerator {
	...
	def generateAppClass(IFolder appPackage, IFile mofgenFile) {
		...
		imports.addAll('java.util.LinkedList', 'java.util.List', 'org.moflon.mofgen.api.MofgenApp',
			'org.moflon.mofgen.api.' + GENERATOR_SUPER_CLASS,
	...
	def generateGenClass(IFolder genPackage, Generator gen) {
		...
		val imports = newHashSet('java.util.ArrayList', 'java.util.List', 'java.util.Map', 'java.util.HashMap',
			'java.util.LinkedList', 'org.eclipse.emf.ecore.EObject', 'org.eclipse.emf.ecore.util.EcoreUtil', 'org.moflon.mofgen.api.' + GENERATOR_SUPER_CLASS)
	...
	def generatePatternClass(IFolder patternPackage, Pattern pattern) {
		...
		imports.addAll(
			'org.moflon.mofgen.api.' + PATTERN_SUPER_CLASS,
			'org.eclipse.emf.ecore.EObject'
		)
