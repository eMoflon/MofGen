...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Gen Pattern Call</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.mofgen.mGLang.impl.GenPatternCallImpl#getCalledPattern <em>Called Pattern</em>}</li>
 *   <li>{@link org.mofgen.mGLang.impl.GenPatternCallImpl#getParams <em>Params</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GenPatternCallImpl extends MinimalEObjectImpl.Container implements GenPatternCall
{
  /**
  ...
  {
    return MGLangPackage.Literals.GEN_PATTERN_CALL;
  }
    ...
    if (calledPattern != null && calledPattern.eIsProxy())
    {
      ...
      if (calledPattern != oldCalledPattern)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MGLangPackage.GEN_PATTERN_CALL__CALLED_PATTERN, oldCalledPattern, calledPattern));
      }
    }
  ...
  public void setCalledPattern(Pattern newCalledPattern)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MGLangPackage.GEN_PATTERN_CALL__CALLED_PATTERN, oldCalledPattern, calledPattern));
  }
  ...
  public EList<PatternObject> getParams()
  {
    if (params == null)
    {
      params = new EObjectContainmentEList<PatternObject>(PatternObject.class, this, MGLangPackage.GEN_PATTERN_CALL__PARAMS);
    }
    return params;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MGLangPackage.GEN_PATTERN_CALL__PARAMS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MGLangPackage.GEN_PATTERN_CALL__CALLED_PATTERN:
